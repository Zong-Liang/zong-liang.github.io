...
# 01 数组 / 字符串
create_files_in_folder "01_数组_字符串" \
...
# 03 滑动窗口
create_files_in_folder "03_滑动窗口" \
...
# 10 二叉树层次遍历
create_files_in_folder "10_二叉树层次遍历" \
...
# 17 Kadane算法
create_files_in_folder "17_Kadane算法" \
"2024-03-02-53-最大子数组和" \
"2024-03-02-918-环形子数组的最大和"

# 18 二分查找
create_files_in_folder "18_二分查找" \
...
# 22 一维动态规划
create_files_in_folder "22_一维动态规划" \
"2024-03-02-70-爬楼梯" \
"2024-03-02-198-打家劫舍" \
"2024-03-02-139-单词拆分" \
"2024-03-02-322-零钱兑换" \
...
# 23 多维动态规划
create_files_in_folder "23_多维动态规划" \
