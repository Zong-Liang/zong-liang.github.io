---
title: "01-专业技能知识问答"
date: 2024-03-17 16:56:16 +0800
categories: [知识问答, 专业技能知识问答]
tags: [知识问答, 专业技能知识问答]
pin: false
toc: true
math: true
...
4.  **追求“覆盖索引”，避免“回表”**
    ...
    - **实践**: 对于商品详情页这种 QPS 极高的场景，我会为查询的字段（如`product_id`, `name`, `price`, `stock`）建立一个复合索引。这样，当查询这些信息时，可以直接从索引中获取所有数据，极大地降低了数据库的 I/O 压力，这也是我简历中“**商品详情页 QPS 从 500 提升至 4,000+**”背后，除了多级缓存之外，数据库层面最核心的优化之一。
